...
public class NativeConfigFiles
{
    ...
    public static void syncConfigFiles( GamePrefs game, GlobalPrefs global, AppData appData )
    {
        ...
        putGliden64( mupen64plus_cfg, game, "configVersion", "3" );                                                         // Settings version. Don't touch it.
        ...
        putGliden64( mupen64plus_cfg, game, "bilinearMode", "True" );                                                       // Bilinear filtering mode (0=N64 3point, 1=standard)
        putGliden64( mupen64plus_cfg, game, "MaxAnisotropy", "False" );                                                     // Max level of Anisotropic Filtering, 0 for off
        ...
        putGliden64( mupen64plus_cfg, game, "ValidityCheckMethod", "False" );                                               // Method to check validity of auxiliary texture frame buffer (0=write fingerprint to the buffer, 1=fill whole buffer in RDRAM with test value)
        ...
        putGliden64( mupen64plus_cfg, game, "txDump", "False" );                                                            // Enable dump of loaded N64 textures.
        ...
        putGliden64( mupen64plus_cfg, game, "fontName", "FreeSans.ttf" );                                                   // File name of True Type Font for text messages.
